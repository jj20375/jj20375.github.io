<template>
    <div>
        ...
        <svg version="1.1"
             viewBox="0 0 105.07 92.6"
             style="enable-background:new 0 0 105.07 92.6;">
            <g>
                ...
                <g class="circle">
                    ...
                    <g>
                        <g>
                            <path class="st1 path"
                                  d="M68.04,36.7c-0.97,1.11-2.1,2.02-3.26,2.88c-1.17,0.85-2.38,1.64-3.62,2.37c-1.24,0.71-2.5,1.48-3.92,1.9
					...
					C65.65,38.36,66.77,37.46,67.69,36.4z" />
                        ...
                        <path class="st2 path"
                              d="M37.02,36.55c1.83,2.14,5.65,4.66,8.86,6.34c3.21,1.68,6.11,1.07,6.11,1.07s0,0-1.73-0.99
				...
				c0,1.82,0.24,3.5,0.52,4.88C33.94,34.74,36.27,35.67,37.02,36.55z" />
                        <path class="st2 path"
                              d="M73.19,24.2l-1.51,0.55c0,0-9.31,4.94-11.68,9.14c-2.37,4.2-3.63,8.09-5.37,9.08
				...
				c0.4-1.55,0.63-3.43,0.63-5.69C73.47,27.21,73.36,25.75,73.19,24.2z" />
                    ...
                    <circle class="st3"
                            ...
                            r="3.46" />
                    <path class="st3 path"
                          d="M65.7,23.7c0,1.47-1.19-1.29-2.67-1.29s-2.67,2.77-2.67,1.29s1.19-2.67,2.67-2.67S65.7,22.22,65.7,23.7z" />
                    <g>
                        <path class="st1 path"
                              d="M61.73,16.14c-0.48,0.65-1.1,1.01-1.74,1.34c-0.63,0.34-1.26,0.7-1.87,1.08c-1.21,0.76-2.39,1.61-3.31,2.63
				...
				C61.78,16.04,61.76,16.09,61.73,16.14L61.73,16.14z" />
                    ...
                    <g>
                        <path class="st1 path"
                              d="M43.35,15.72c0.83-0.01,1.5,0.33,2.14,0.71c0.64,0.38,1.27,0.78,1.88,1.2c1.22,0.86,2.42,1.77,3.4,2.98
				...
				c-0.08-0.11-0.06-0.28,0.05-0.36C43.25,15.74,43.3,15.72,43.35,15.72z" />
                    ...
                    <g>
                        <path class="st1 path"
                              d="M55.2,32.7c-0.25,0.54-0.57,1.03-0.92,1.49c-0.13,0.21-0.46,0.55-0.78,0.73c-0.34,0.19-0.73,0.29-1.12,0.3
				...
				c0.19-0.08,0.28-0.14,0.53-0.36c0.44-0.37,0.9-0.72,1.43-1.01L55.2,32.7z" />
                    ...
                    <path class="st4 path"
                          d="M55.08,32.44c0,1.31-1.39,2.38-2.7,2.38c-1.31,0-2.7-1.06-2.7-2.38c0-1.31,1.56-1.43,2.87-1.43
			C53.86,31.01,55.08,31.12,55.08,32.44z" />
                    <g>
                        <path class="st1 path"
                              d="M55.37,39.39c0,0.38-0.27,0.62-0.51,0.79c-0.25,0.17-0.51,0.28-0.78,0.37c-0.54,0.17-1.11,0.24-1.67,0.23
				...
				C54.43,40.03,55.02,39.79,55.07,39.39z" />
                    ...
                    <path class="st1 path"
                          d="M66.95,17.32c-1.91,0-2.78-7-2.78-7c-0.94-3.5,1.14-7.09,4.63-8.02L77.37,0L78,2.33
			C80.21,10.56,68.85,17.32,66.95,17.32z" />
                    <path class="st0 path"
                          d="M66.05,17.94c-1.62,0-2.36-5.93-2.36-5.93c-0.79-2.96,0.96-6.01,3.93-6.8l7.27-1.95l0.53,1.98
			C77.3,12.21,67.67,17.94,66.05,17.94z" />
                    <path class="st1 path"
                          d="M38.18,17.32c1.91,0,2.78-7,2.78-7c0.94-3.5-1.14-7.09-4.63-8.02L27.75,0l-0.62,2.33
			C24.92,10.56,36.27,17.32,38.18,17.32z" />
                    <path class="st0 path"
                          d="M39.07,17.94c1.62,0,2.36-5.93,2.36-5.93c0.79-2.96-0.96-6.01-3.93-6.8l-7.27-1.95L29.7,5.23
			C27.83,12.21,37.45,17.94,39.07,17.94z" />
                    <path class="st1 path"
                          d="M61.64,20.01c0.01,0,0.02,0,0.02,0c0.6-0.05,0.79-0.83,0.25-1.1c-0.08-0.04-0.16-0.08-0.24-0.12
			...
			z" />
                    <path class="st1 path"
                          d="M42.15,20.01c-0.01,0-0.02,0-0.02,0c-0.6-0.05-0.79-0.83-0.25-1.1c0.08-0.04,0.16-0.08,0.24-0.12
			...
			" />
                    <circle class="st0"
                            ...
                            r="2.79" />
                    <path class="st3 path"
                          d="M54.44,39.98c0,1.09-0.88,4.08-1.98,4.08s-1.98-2.99-1.98-4.08c0-1.09,0.88-0.96,1.98-0.96
			S54.44,38.89,54.44,39.98z" />
                    <g>
                        <path class="st0 path"
                              d="M28.26,22.34c-0.66-2.68-1.77-4.81-3.32-6.42c-1.55-1.6-3.47-2.4-5.75-2.4c-1.88,0-3.39,0.5-4.51,1.49
				...
				c0.46,1.52,0.79,3.13,0.99,4.83c0.2,1.7,0.3,3.54,0.3,5.52H28.26z" />
                        <path class="st0 path"
                              d="M16.6,50.88v-2c1.89,0,2.83-1.54,2.83-4.61V14.52c0-3.92-0.98-5.88-2.95-5.88v-2h8.65v2
				c-1.83,0-2.75,1.96-2.75,5.88v29.75c0,3.07,0.95,4.61,2.86,4.61v2H16.6z" />
                    </g>
                    <g>
                        <path class="st0 path"
                              d="M75.35,22.34c0-1.98,0.1-3.82,0.3-5.52c0.2-1.7,0.53-3.31,0.99-4.83c1.12,0.33,2.2,0.91,3.22,1.73
				...
				c-2.28,0-4.19,0.8-5.75,2.4c-1.55,1.6-2.66,3.74-3.32,6.42H75.35z" />
                        <path class="st0 path"
                              d="M79.85,50.88v-2c1.91,0,2.86-1.54,2.86-4.61V14.52c0-3.92-0.91-5.88-2.75-5.88v-2h8.65v2
                ...
                <g>
                    <g>
                        <path class="st0 path"
                              d="M23.12,79.32c-0.08,0.17-0.17,0.34-0.28,0.53c0.72,0.55,1.47,1.22,1.96,1.74l-0.23,0.28
				...
				L28.19,84.4z M29.79,80.38c-0.38-0.24-1.09-0.6-1.67-0.8l0.17-0.24c0.57,0.21,1.3,0.53,1.67,0.78L29.79,80.38z" />
                        <path class="st0 path"
                              d="M43.67,83.38c-1.88,0.32-3.83,0.67-5.14,0.88l-0.07-0.34l0.85-0.14v-3.54h0.33v3.5l1.46-0.25v-4.24h0.33
				...
				c1.08,0.61,2.34,1.5,2.96,2.13l-0.21,0.26c-0.63-0.64-1.89-1.57-2.97-2.18L45.34,86.51z" />
                        <path class="st0 path"
                              d="M61.65,84.25c1.06,1.92,3.09,3.69,5.06,4.47c-0.09,0.08-0.2,0.2-0.25,0.29c-1.78-0.77-3.66-2.36-4.81-4.12
				...
				c0.89-0.76,1.46-1.93,1.72-3.35L64.6,81.85z" />
                        <path class="st0 path"
                              d="M82.36,89c1.12,0,1.3-0.47,1.43-2.26c0.11,0.08,0.24,0.14,0.34,0.17c-0.15,1.82-0.34,2.42-1.86,2.42h-4.46
                ...
                <g>
                    <g>
                        <path class="st0 path"
                              d="M102.72,75.77c-1.23,2.93-3.15,5.71-5.74,7.59c-1.31,0.95-2.76,1.68-4.31,2.12c-1.4,0.4-3.59,0.9-4.91,0.07
                ...
                <g>
                    <g>
                        <path class="st0 path"
                              d="M0.06,76.39c1.51,3.62,3.78,6.87,7.03,9.13c1.59,1.1,3.42,1.93,5.31,2.36c1.88,0.43,4.3,0.75,6.02-0.33
                ...
                <g>
                    ...
                    <g>
                        <path class="path st6"
                              d="M20.91,72.34c-0.29,0.28-0.65,0.42-1.09,0.42h-0.07c-1.15,0-2.12-0.39-2.9-1.18
				...
				c0.44,0,0.8,0.14,1.09,0.43c0.29,0.29,0.43,0.65,0.43,1.09C21.34,71.7,21.2,72.06,20.91,72.34z" />
                        <path class="path st1"
                              d="M23.71,68.99c-1.35,0-2.47-0.46-3.39-1.37c-0.91-0.91-1.37-2.05-1.37-3.4c0-1.35,0.46-2.47,1.37-3.39
				...
				c0-0.48-0.17-0.89-0.51-1.23C24.61,62.65,24.19,62.49,23.71,62.49z" />
                        <path class="path st1"
                              d="M39.12,72.34c-0.29,0.28-0.65,0.42-1.09,0.42h-0.07c-1.17,0-2.14-0.39-2.92-1.17
				...
				c0.44,0,0.8,0.14,1.09,0.43c0.29,0.29,0.43,0.65,0.43,1.09C39.55,71.7,39.41,72.06,39.12,72.34z" />
                        <path class="path st6"
                              d="M51.13,68.84c-0.32,0.08-0.66,0.12-1.02,0.12c-1.16,0-2.14-0.39-2.91-1.17c-0.78-0.78-1.16-1.75-1.16-2.91
				...
				" />
                        <path class="path st6"
                              d="M67.29,68.57c-0.29,0.28-0.65,0.42-1.09,0.42c-1.83,0-3.38-0.63-4.64-1.89c-1.26-1.26-1.9-2.81-1.9-4.64
				...
				C67.72,67.92,67.58,68.28,67.29,68.57z" />
                        <path class="path st6"
                              d="M72.69,68.99c-1.35,0-2.47-0.46-3.39-1.37c-0.91-0.91-1.37-2.05-1.37-3.4c0-1.35,0.46-2.47,1.37-3.39
				c0.91-0.91,2.04-1.37,3.39-1.37c1.35,0,2.48,0.46,3.4,1.37c0.91,0.91,1.37,2.04,1.37,3.39c0,1.35-0.46,2.48-1.37,3.4
				...
				C73.59,62.65,73.18,62.49,72.69,62.49z" />
                        <path class="path st1"
                              d="M92.92,72.34c-0.29,0.28-0.65,0.42-1.09,0.42h-0.07c-1.15,0-2.12-0.39-2.91-1.18s-1.17-1.75-1.17-2.9v-5.16
				...
				c0.29,0.29,0.43,0.65,0.43,1.09C93.35,71.7,93.21,72.06,92.92,72.34z" />
                        <path class="path st1"
                              d="M44.12,66.93c-0.42,0.33-0.86,0.58-1.31,0.75c-0.45,0.16-0.93,0.25-1.45,0.25c-0.41,0-0.81-0.06-1.21-0.18
				...
				c0.19,0,0.38-0.05,0.57-0.16c0.19-0.1,0.33-0.24,0.41-0.4L44.12,66.93z" />
                        <path class="path st1"
                              d="M97.9,66.93c-0.42,0.33-0.86,0.58-1.31,0.75c-0.45,0.16-0.93,0.25-1.45,0.25c-0.41,0-0.81-0.06-1.21-0.18
				c-0.4-0.12-0.78-0.31-1.13-0.55c-0.59-0.39-1.06-0.89-1.38-1.5c-0.33-0.61-0.49-1.27-0.49-1.99c0-0.56,0.11-1.1,0.32-1.61
				c0.22-0.52,0.52-0.97,0.92-1.36c0.4-0.41,0.86-0.72,1.38-0.94c0.51-0.22,1.05-0.32,1.6-0.32c1.24,0,2.25,0.42,3.04,1.26
...
<style lang="scss">
    .st0{fill:#00374C;}
.st1{fill:#FBECDD;}
.st2{fill:#FBECDD;stroke:#FBECDD;stroke-width:0.4623;stroke-miterlimit:10;}
.st3{fill:#FFFFFF;}
.st4{fill:none;stroke:#FBECDD;stroke-width:0.4623;stroke-miterlimit:10;}
.st5{fill:none;stroke:#00374C;stroke-width:0.4623;stroke-miterlimit:10;}
.st6{fill:none;stroke:#FFFFFF;stroke-width:0.4623;stroke-miterlimit:10;}
.path {
